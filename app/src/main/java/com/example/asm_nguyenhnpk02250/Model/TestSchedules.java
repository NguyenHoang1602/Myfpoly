...
public class TestSchedules implements Serializable {

    private Integer test_Schedule_ID , Slot_ID;
    ...
    public TestSchedules(Integer test_Schedule_ID, Integer slot_ID, String room_ID, String amphitheater_ID, String subject_ID, String classroom_ID, String lecturers_ID, String time, String room_Name, String amphitheater_Name, String name, String classroom_Name, String date) {
        this.test_Schedule_ID = test_Schedule_ID;
        Slot_ID = slot_ID;
        Room_ID = room_ID;
    ...
    public Integer getTest_Schedule_ID() {
        return test_Schedule_ID;
    }

    public void setTest_Schedule_ID(Integer test_Schedule_ID) {
        this.test_Schedule_ID = test_Schedule_ID;
    }
