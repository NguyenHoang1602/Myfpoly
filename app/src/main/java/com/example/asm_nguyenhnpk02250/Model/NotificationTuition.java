...
public class NotificationTuition implements Serializable {
    private String Notification_ID, Publishers, C_NotificatonID , Title, Details, Time;

    public NotificationTuition() {
    }

    public NotificationTuition(String notification_ID, String publishers, String c_NotificatonID, String title, String details, String time) {
